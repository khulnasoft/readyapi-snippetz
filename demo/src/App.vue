...
import { type ClientId, type TargetId} from '@readyapi/snippetz-core'
import { ref } from 'vue'
...
<template>
  ...
  <div class="introduction">
    <p>
      @readyapi/snippetz is a library that generates code snippets for making HTTP requests in Node.js and the browser.
    </p>
  </div>
